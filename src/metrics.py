# Evaluation protocol from THREATRACE (IEEE TIFS vol. 17, 2022); the test-set
# convention follows MAGIC (https://github.com/FDUDSDE/MAGIC), MIT License.
...
def best_f1_threshold(y, s):
    """The community best-F1 operating point on the PR curve."""
...
def score_report(dataset, scores, test_node_counts, edge_index=None, hops=2):
    """-> {'precision', 'recall', 'f1', 'auc'} at the best-F1 point.
    ...
    the aggregate numbers.  Pass `edge_index` to score under the
