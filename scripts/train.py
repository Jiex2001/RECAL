"""Training.  python -m scripts.train --config configs/cadets.yaml

Per-file full-graph gradient updates, Adam, 50 epochs, seed 0.  The
calibration graph is excluded from training.
"""
